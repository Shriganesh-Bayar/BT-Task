...
if (isMember === "yes") {
    ...
    const calculateDiscount = getDiscountFunction(membershipType);
    discountAmount = calculateDiscount(grandTotal);
}
...
async function processOrder() {
    ...
    console.log(`Thank you for shopping, A confirmation has been sent to ${email}.`);
}
